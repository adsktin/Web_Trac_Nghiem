...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                <h5 class="card-header">Tạo Tài Khoản Admin</h5>
                <!-- Account -->
                <div class="card-body">
                ...
                <div class="card-body">
                    <div class="mb-3 col-12 mb-0">
                        <div class="alert alert-warning">
                            <h6 class="alert-heading fw-bold mb-1">Bạn có chắc là muốn xóa tài khoản này không?</h6>
                    ...
                    <form id="formAccountDeactivation" onsubmit="return false">
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="accountActivation">Tôi xác nhận về việc xóa vĩnh viễn tài
                                khoản này</label>
                        </div>
